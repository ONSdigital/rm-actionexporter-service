...
public class ActionEvent implements Serializable, ToString2 {
  ...
  public static <_B> Builder<_B> copyOf(final ActionEvent _other) {
  ...
  public static Builder<Void> copyOnly(final ActionEvent _other, final PropertyTree _propertyTree) {
  ...
  public static class Builder<_B> implements Buildable {
     ...
     */
    public Builder<_B> addEvents(final Iterable<? extends String> events) {
      if (events != null) {
        if (this.events == null) {
          this.events = new ArrayList<Buildable>();
        }
     ...
     */
    public Builder<_B> withEvents(final Iterable<? extends String> events) {
      if (this.events != null) {
        this.events.clear();
      }
     ...
     * @param events Items to add to the value of the "events" property
     */
    public Builder<_B> addEvents(String... events) {
     ...
     * @param events New value of the "events" property.
     */
    public Builder<_B> withEvents(String... events) {
