...
public class ExportEndpoint {
    ...
    public ResponseEntity<String> triggerExport() throws CTPException{
        try {
            ...
            log.error("Uncaught exception - transaction rolled back. Will re-run when scheduled by cron", e);
            throw new CTPException(CTPException.Fault.SYSTEM_ERROR, "Uncaught exception when exporting print file");
        }
    }
}