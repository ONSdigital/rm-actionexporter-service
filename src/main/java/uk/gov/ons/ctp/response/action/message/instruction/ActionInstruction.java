...
public class ActionInstruction implements Serializable, ToString2 {
  ...
  public static <_B> Builder<_B> copyOf(final ActionInstruction _other) {
  ...
  public static class Builder<_B> implements Buildable {
    ...
    private ActionCancel.Builder<Builder<_B>> actionCancel;
    private ActionUpdate.Builder<Builder<_B>> actionUpdate;
    private ActionRequest.Builder<Builder<_B>> actionRequest;
     ...
     */
    public Builder<_B> withActionCancel(final ActionCancel actionCancel) {
      this.actionCancel =
          ((actionCancel == null)
              ? null
              : new ActionCancel.Builder<Builder<_B>>(this, actionCancel, false));
      return this;
    }

    /**
     * Returns a new builder to build the value of the "actionCancel" property (replacing previous
     * value). Use {@link ActionCancel.Builder#end()} to return to the current builder.
     *
     * @return A new builder to build the value of the "actionCancel" property. Use {@link
     *     ActionCancel.Builder#end()} to return to the current builder.
     */
    public ActionCancel.Builder<? extends Builder<_B>> withActionCancel() {
      return this.actionCancel = new ActionCancel.Builder<Builder<_B>>(this, null, false);
    }
     ...
     */
    public Builder<_B> withActionUpdate(final ActionUpdate actionUpdate) {
      this.actionUpdate =
          ((actionUpdate == null)
              ? null
              : new ActionUpdate.Builder<Builder<_B>>(this, actionUpdate, false));
      return this;
    }

    /**
     * Returns a new builder to build the value of the "actionUpdate" property (replacing previous
     * value). Use {@link ActionUpdate.Builder#end()} to return to the current builder.
     *
     * @return A new builder to build the value of the "actionUpdate" property. Use {@link
     *     ActionUpdate.Builder#end()} to return to the current builder.
     */
    public ActionUpdate.Builder<? extends Builder<_B>> withActionUpdate() {
      return this.actionUpdate = new ActionUpdate.Builder<Builder<_B>>(this, null, false);
    }
     ...
     */
    public Builder<_B> withActionRequest(final ActionRequest actionRequest) {
      this.actionRequest =
          ((actionRequest == null)
              ? null
              : new ActionRequest.Builder<Builder<_B>>(this, actionRequest, false));
      return this;
    }

    /**
     * Returns a new builder to build the value of the "actionRequest" property (replacing previous
     * value). Use {@link ActionRequest.Builder#end()} to return to the current builder.
     *
     * @return A new builder to build the value of the "actionRequest" property. Use {@link
     *     ActionRequest.Builder#end()} to return to the current builder.
     */
    public ActionRequest.Builder<? extends Builder<_B>> withActionRequest() {
      return this.actionRequest = new ActionRequest.Builder<Builder<_B>>(this, null, false);
    }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private ActionCancel.Selector<TRoot, Selector<TRoot, TParent>> actionCancel = null;
    private ActionUpdate.Selector<TRoot, Selector<TRoot, TParent>> actionUpdate = null;
    private ActionRequest.Selector<TRoot, Selector<TRoot, TParent>> actionRequest = null;
    ...
    public ActionCancel.Selector<TRoot, Selector<TRoot, TParent>> actionCancel() {
      return ((this.actionCancel == null)
          ? this.actionCancel =
              new ActionCancel.Selector<TRoot, Selector<TRoot, TParent>>(
                  this._root, this, "actionCancel")
          : this.actionCancel);
    }

    public ActionUpdate.Selector<TRoot, Selector<TRoot, TParent>> actionUpdate() {
      return ((this.actionUpdate == null)
          ? this.actionUpdate =
              new ActionUpdate.Selector<TRoot, Selector<TRoot, TParent>>(
                  this._root, this, "actionUpdate")
          : this.actionUpdate);
    }

    public ActionRequest.Selector<TRoot, Selector<TRoot, TParent>> actionRequest() {
      return ((this.actionRequest == null)
          ? this.actionRequest =
              new ActionRequest.Selector<TRoot, Selector<TRoot, TParent>>(
