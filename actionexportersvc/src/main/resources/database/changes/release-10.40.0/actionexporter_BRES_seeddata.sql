...
VALUES ('initialPrint','<#list actionRequests as actionRequest>${(actionRequest.address.sampleunitrefpk)!}|${actionRequest.iac?trim}|${(actionRequest.contact.forename)!}|${(actionRequest.contact.surname)!}</#list>'  , now());
